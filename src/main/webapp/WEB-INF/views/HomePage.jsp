<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body class="bg-white">
            ...
            <div>
                <nav class="fixed w-full bg-gray-100 text-indigo-500 shadow-xl p-4 flex justify-between items-center">
                    ...
                    <div class="sm:flex sm:items-center sm:text-xs">
                        <button
                            class="p-1.5 sm:mr-10 rounded-md text-white bg-indigo-600 text-lg font-medium hover:bg-indigo-700"><a
                    ...
                    <div class="w-full mt-6 flex flex-row flex-wrap gap-10 items-center justify-evenly">
                        <div class="w-full md:w-1/3 shadow-lg rounded-lg">
                            <a href="homelistproduct"
                                class="bg-white text-indigo-500 rounded-lg p-4 flex flex-col items-center cursor-pointer hover:text-black hover:bg-indigo-100">
