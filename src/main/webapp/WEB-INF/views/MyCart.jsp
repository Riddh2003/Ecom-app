...
<body class="bg-gray-100">
	<nav class="bg-gray-900 text-white p-4 sticky top-0 z-10">
		<div
			...
			<h1 class="text-2xl md:text-3xl font-bold mb-2 sm:mb-0">Product
				List</h1>
			<div class="flex space-x-4">
				<a href="customerhomepage"
					class="text-lg hover:bg-gray-700 rounded-md p-2 transition duration-300">Home</a>
				<a href="homelistproduct"
					class="text-lg hover:bg-gray-700 rounded-md p-2 transition duration-300">Products
					List</a>
			</div>
		</div>
	</nav>
	...
	<section class="container mx-auto py-8 px-4">
						...
						<div class="flex justify-between items-center">
							...
							<div>
								<a href="removefromcart?productId=${p.productId}"
									class="text-red-500 hover:text-red-700 mr-2"> <i
		...
		<form action="buy" method="post"
			...
			<input type="submit"
				class="w-full text-center md:w-1/2 bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition duration-300" value="Buy"/>
		</form>
	</section>
</body>
